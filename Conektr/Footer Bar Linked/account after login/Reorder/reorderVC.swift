...
class reorderVC: UIViewController {
    ...
    func cellview(){
        ...
        let scroll = UI()
        scroll.ScrollView(x: 10, y: 10, width: cell.frame.size.width-20, height: cell.frame.size.height-20, bkcolor: #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), contentwidth: view.frame.size.width, contentheight: view.frame.size.height, view: cell)
